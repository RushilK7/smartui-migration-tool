import { MigrationResult, ReportResult, MigrationStatistics, ScanResult, TransformResult, CodeTransformResult, ExecutionTransformResult, FinalReportData, DetectionResult, TransformationWarning } from '../types';
...
export class Reporter {
   ...
   */
  public async generateReport(reportData: FinalReportData): Promise<string> {
   ...
   */
  private async generateConsoleReport(migrationResult: MigrationResult): Promise<void> {
   ...
   */
  private async generateHTMLReport(migrationResult: MigrationResult): Promise<string> {
   ...
   */
  private async generateJSONReport(migrationResult: MigrationResult): Promise<string> {
   ...
   */
  private async generateMarkdownReport(migrationResult: MigrationResult): Promise<string> {
   ...
   */
  private generateAppiumNextSteps(language: string): string {
   ...
   */
  private generateStandardNextSteps(language: string): string {
   ...
   */
  private generateReportHeader(startTime: Date, endTime: Date): string {
...
`;
   ...
   */
  private generateMigrationSummaryTable(detectionResult: DetectionResult, totalFilesProcessed: number, snapshotCount: number): string {
...
`;
   ...
   */
  private generateFilesChangedSection(filesCreated: string[], filesModified: string[]): string {
...
`;
   ...
   */
  private generateWarningsSection(warnings: TransformationWarning[]): string {
...
`;
   ...
   */
  private generateNextStepsSection(detectionResult: DetectionResult): string {
...
`;
   ...
   */
  private generateInstallDependenciesStep(detectionResult: DetectionResult): string {
...
`;
   ...
   */
  private generateConfigureSecretsStep(): string {
...
`;
   ...
   */
  private generateRunTestsStep(detectionResult: DetectionResult): string {
...
`;
   ...
   */
  private generateAdditionalNotes(detectionResult: DetectionResult): string {
...
`;
   ...
   */
  private getTestTypeDisplay(testType: string): string {
    switch (testType) {
      case 'e2e':
   ...
   */
  private calculateStatistics(migrationResult: MigrationResult): MigrationStatistics {
