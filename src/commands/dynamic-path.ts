...
export default class DynamicPath extends Command {
  static description = 'Handle dynamic path scanning for visual testing patterns';
  ...
  async run(): Promise<void> {
    ...
    const { args } = await this.parse(DynamicPath);
