...
export class ProgressManager {
   ...
   */
  private getDefaultFormat(options: ProgressOptions): string {
    const parts = [
      '{title}',
      '|{bar}|',
      '{percentage}%',
   ...
   */
  static createFileProgress(totalFiles: number, verbose: boolean = false): ProgressManager {
   ...
   */
  static createScanProgress(totalSteps: number, verbose: boolean = false): ProgressManager {
    const progress = new ProgressManager(verbose);
    progress.start({
   ...
   */
  static createTransformProgress(totalFiles: number, verbose: boolean = false): ProgressManager {
    const progress = new ProgressManager(verbose);
    progress.start({
   ...
   */
  static createPreviewProgress(totalFiles: number, verbose: boolean = false): ProgressManager {
    const progress = new ProgressManager(verbose);
    progress.start({
